...
```bash
git-worktree-zellij <branch-name>
git-worktree-zellij new <branch-name>
git-worktree-zellij del <branch-name>
git-worktree-zellij delete <branch-name>
git-worktree-zellij help
```
